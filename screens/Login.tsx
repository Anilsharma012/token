  ...
  return (
    <div className="h-full flex flex-col bg-white p-8 animate-fade-in">
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400 font-medium text-center mb-12">Connect with your future career in seconds.</p>

        {step === 'info' ? (
          <div className="w-full space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-2">Mobile Number</label>
      ...
      <p className="text-[10px] text-center text-gray-300 font-bold px-8 leading-relaxed">
