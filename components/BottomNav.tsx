  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 mx-auto w-full max-w-md bg-white border-t border-gray-100 flex justify-around items-center px-2 pt-3 pb-8 z-40 safe-bottom">
      ...
      <div className="relative -mt-10">
        ...
        <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[10px] font-medium text-gray-400 w-full text-center">Place ad</span>
      </div>

      <NavItem screen={AppScreen.CHATS} icon="chat_bubble_outline" label="Chats" />
